    ...
    def get_response(self):
        ...
        if int(id) == 1:
            ...
            if attr_mem and vals_mem:
                ...
                data["line_mem"] = "<div class='alert-danger'>没有[1小时内]内存数据</div>"
            ...
            if attr_swap and vals_swap:
                ...
                data["line_swap"] = "<div class='alert-danger'>没有[1小时内]交换分区数据</div>"
            ...
            if attr_cpu and vals_cpu:
                ...
                data["line_cpu"] = "<div class='alert-danger'>没有[1小时内]CPU数据</div>"
